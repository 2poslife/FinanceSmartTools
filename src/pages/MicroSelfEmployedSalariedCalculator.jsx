    ...
    return (
        <div className="calcpage" dir="rtl">
            ...
            <section className="calcpage-description">
                ...
                <p>
                    מחשב את תשלומי הביטוח הלאומי והבריאות לעצמאי זעיר שיש לו גם הכנסה כשכיר,
                    כולל בדיקה ייחודית להכנסה החייבת מעבר לסף המינימום.
                </p>

                <h2>למי זה מתאים?</h2>
                <ul>
                    <li>עצמאים שעובדים גם כשכירים</li>
                    <li>מי שרוצה לבדוק חבות משולבת מול המוסד לביטוח לאומי</li>
                    <li>עוסקים פטורים או פרילנסרים עם הכנסה נוספת</li>
                </ul>

                <h2>למה להשתמש?</h2>
                <ul>
                    <li>✔️ חישוב משולב לעצמאי + שכיר</li>
                    <li>✔️ חישוב אוטומטי להכנסה מעל סף מינימום</li>
                    <li>✔️ כלי עזר לתכנון תזרים ומיסוי</li>
                </ul>

                <h2>כתב ויתור</h2>
                <p className="disclaimer">
                    המחשבון מספק אומדן בלבד ואינו מהווה ייעוץ מס אישי. ייתכנו תנאים נוספים
                    המשפיעים על התוצאה בפועל. מומלץ להתייעץ עם רו״ח או יועץ מס מוסמך.
                </p>
            </section>
        </div>
    );
