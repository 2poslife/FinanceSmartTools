...
// Constants moved outside component to prevent recreation (same as desktop)
const INCOME_BRACKETS_MOBILE = {
...
const findBracketIndexMobile = (income, year) => {
    const brackets = INCOME_BRACKETS_MOBILE[year] || INCOME_BRACKETS_MOBILE[2024];
...
const findBracketIndexFor5_6Mobile = (income, year) => {
    const bracketIdx = findBracketIndexMobile(income, year);
    return 9 - bracketIdx;
};
...
function EquityComparisonUrbanMobile() {
    ...
    // ----- Table 3-4 and 5-6 data (constants moved outside component) -----
    ...
    const value_3_4 = useMemo(() => {
        ...
        years.forEach((year, idx) => {
            ...
            if (totalIncome > 0 && familyCount) {
                const yearData = TABLE_3_4_DATA_MOBILE[year] || TABLE_3_4_DATA_MOBILE[2024];
                const bracketIdx = findBracketIndexMobile(totalIncome, year);
    ...
    const value_5_6 = useMemo(() => {
        ...
        years.forEach((year, idx) => {
            ...
            if (totalIncome > 0 && familyCount) {
                const yearData = TABLE_5_6_DATA_MOBILE[year] || TABLE_5_6_DATA_MOBILE[2024];
                const bracketIdx = findBracketIndexFor5_6Mobile(totalIncome, year);
                const familyIdx = getFamilySizeIndex(familyCount);
