    ...
    return (
        <div className="calcpage" dir="rtl">
            ...
            <section className="calcpage-description">
                ...
                <p>
                    המחשבון מקבל את ההכנסה השנתית לאחר ההוצאות שהזנתם ומחשב את ההכנסה החייבת (70% מהברוטו). על בסיס זה הוא מחשב את תשלומי הביטוח הלאומי והבריאות, ומציג לכם את התשלום החושי והשנתי.
                </p>
